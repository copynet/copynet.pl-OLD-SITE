...
<td>'.date(DATE_FORMAT, intval($dir_time[$ii])).'</td>
';
if (ENABLE_RENAME){
...
if (ENABLE_DELETE){
echo '<td><!-- <input class="delcheckbox" type="checkbox" name="file_to_del['.$file['name'][$i].']" value="1" /> -->

<form onsubmit="ImageDialog.insert();return false;" action="#"> 
<input type="hidden" name="src" value="'.$file['name'][$i].'" />
...
<br />
<input type='hidden' name='upload_path' id='upload_path' value='images/2.png<?php echo WORKING_PATH?>'>
